  ...
  return (
    <>
      ...
      <section className="bg-construction-graphite px-5 py-20 text-white">
        <div className="mx-auto max-w-7xl rounded-3xl border border-white/10 bg-white/5 p-8 shadow-sm backdrop-blur-sm md:p-12">
        ...
        <div className="mx-auto mt-10 max-w-7xl rounded-3xl border border-white/10 bg-neutral-900 p-8 md:p-12">
