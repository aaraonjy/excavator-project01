...
export default function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-black/10 bg-black/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
        ...
        <a
          ...
          target="_blank"
          className="rounded-full bg-construction-yellow px-5 py-2.5 text-sm font-bold text-black transition hover:bg-yellow-300"
        >
          WhatsApp Now
        </a>
      </div>
